// GeneralDll.cpp : 定义 DLL 的初始化例程。
//

#include "stdafx.h"
#include <afxdllx.h>
#ifdef _MANAGED
#error 请阅读 GeneralDll.cpp 中的说明以使用 /clr 进行编译
...
{
	CSplashWnd *m_pSplashWnd;				//建立启动画面窗口变量
	m_pSplashWnd = new CSplashWnd();		//建立一个窗口实体
	m_pSplashWnd ->ShowWindow(SW_SHOW);	//显示窗口
