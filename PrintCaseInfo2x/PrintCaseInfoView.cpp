...
void CPrintCaseInfoView::OnPrint(CDC* pDC, CPrintInfo* pInfo)
{
    ...
    case 2:
        ...
        PrintTextMult2(pDC,pInfo, pFemaleInfo->cs_ji_wang_gan_yan.toString(  _T(" 肝炎") ) , 12 );
        PrintTextMult2(pDC,pInfo, pFemaleInfo->cs_jie_he.toString( _T("结核") ) , 12);
        PrintTextMult2(pDC,pInfo, pFemaleInfo->cs_shen_zang_ji_bing.toString(  _T("肾脏疾病") ) );
        NewLine(pDC,pInfo);
        NewHalfLine( pDC ,pInfo , true);
        PrintTextMult2(pDC,pInfo, pFemaleInfo->cs_xin_xue_guan_ji_bing.toString( _T(" 心血管疾病") ) ,6);
        PrintTextMult2(pDC,pInfo, pFemaleInfo->cs_mi_niao_xi_tong_gan_ran.toString( _T("泌尿系统感染") ) , 4 );
        PrintTextMult2(pDC,pInfo, pFemaleInfo->cs_xing_chuan_bo_ji_bing_shi.toString( _T("性传播疾病史") ) );
        NewLine(pDC,pInfo);
        NewHalfLine( pDC ,pInfo , true);
        PrintTextMult2(pDC,pInfo, pFemaleInfo->cs_lan_wei_yan.toString( _T(" 阑尾炎") )  , 10);
		PrintTextMult2(pDC,pInfo, pFemaleInfo->cs_pen_qiang_yan.toString( _T("盆腔炎") ) );
        NewLine(pDC,pInfo);
        NewHalfLine( pDC ,pInfo , true);
